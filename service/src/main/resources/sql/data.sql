...
VALUES (1,  'Java. Библиотеку профессионала. Том 1',              'description', 1102.44, 25, 2010),
       (2,  'Java. Библиотеку профессионала. Том 2',              'description', 954.22,  25, 2012),
...
VALUES  (1,  1, 1,  25, 25 * (SELECT price FROM book WHERE book.id = 1 )),
        ...
        (9,  4, 4,  25, 25 * (SELECT price FROM book WHERE book.id = 4 )),
        (10, 4, 5,  10, 10 * (SELECT price FROM book WHERE book.id = 5 ));
