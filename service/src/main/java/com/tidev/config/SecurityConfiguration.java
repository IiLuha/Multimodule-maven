...
import static com.tidev.database.entity.fields.Role.*;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                .authorizeHttpRequests(urlConfig -> urlConfig
                        .antMatchers("/login", "/users/registration", "/users/create", "/v3/api-docs", "/swagger-ui/**").permitAll()
