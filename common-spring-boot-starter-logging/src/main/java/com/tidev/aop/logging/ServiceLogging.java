...
public class ServiceLogging {
    ...
    @Pointcut("com.tidev.aop.common.CommonAspect.isServiceLayer() && @annotation(org.springframework.transaction.annotation.Transactional)")
    public void anyNotReadOnlyMethod() {
    }

    @Pointcut("com.tidev.aop.common.CommonAspect.isServiceLayer() && execution(public * findById(*))")
    public void anyFindByIdServiceMethod() {
    }

    @Pointcut("com.tidev.aop.common.CommonAspect.isServiceLayer() && execution(public * loadUserByUsername(*))")
    public void loadUserByUsernameServiceMethod() {
    }

    @Pointcut("com.tidev.aop.common.CommonAspect.isServiceLayer() && execution(public * findByFilter(*))")
    public void anyFindByFilterServiceMethod() {
    }

    @Pointcut("com.tidev.aop.common.CommonAspect.isServiceLayer() && execution(public * findAll(*,*))")
    public void anyFindAllServiceMethodReturnsPage() {
    }

    @Pointcut("com.tidev.aop.common.CommonAspect.isServiceLayer() && execution(public java.util.List findAll())")
    public void anyFindAllServiceMethodReturnsList() {
    }

    @Pointcut("com.tidev.aop.common.CommonAspect.isServiceLayer() && execution(public java.util.Optional findImage(*))")
    public void anyFindImageServiceMethod() {
    }

    @Pointcut("com.tidev.aop.common.CommonAspect.isServiceLayer() && execution(public void upload(*,*))")
    public void uploadImageServiceMethod() {
    }

    @Pointcut("com.tidev.aop.common.CommonAspect.isServiceLayer() && execution(public void download(*))")
